...
path.append('/data1/home/liuxiaofeng/code/bluebert-master/mt-bert/mt_bert')
...
def convert(args):
    ...
    path = os.path.join(tf_checkpoint_path, 'model.ckpt-1000000')
...
if __name__ == "__main__":
    ...
    logger.info(args)
    convert(args)
    # state_dict = torch.load('/data1/home/liuxiaofeng/code/bluebert-master/model/pubmedBERT_uncased_fulltext/PubMedBERT_fulltext.bin')
    # config = BertConfig.from_json_file('/data1/home/liuxiaofeng/code/bluebert-master/model/pubmedBERT_uncased_fulltext/config.json')
    # params = {'state': state_dict, 'config': config.to_dict()}
    # torch.save(params, '/data1/home/liuxiaofeng/code/bluebert-master/model/pubmedBERT_uncased_fulltext/PubMedBERT.pt')
