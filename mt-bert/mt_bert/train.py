...
from module.biaffine_pairwise import BiaffinePairwiseScore_3
...
def model_config(parser: argparse.ArgumentParser) -> argparse.ArgumentParser:
    ...
    parser.add_argument('--rg_weight', type=float, default=1)
    return parser
...
def train_config(parser: argparse.ArgumentParser) -> argparse.ArgumentParser:
    ...
    parser.add_argument('--label_word_num', type=int, default=5)
...
def main():
    ...
    for epoch in range(0, args.epochs):
        ...
        for i in range(len(all_indices)):
            ...
            # if 200 <= model.local_updates <= 300:
            #     remaining_time = str(
            ...
            #     model.test(batch_meta, batch_data)
